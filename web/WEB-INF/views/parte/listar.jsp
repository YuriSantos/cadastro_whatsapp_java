    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <table id="example" class="table table-striped">
                ...
                <tbody>
                <c:forEach items="${parte}" var="cadastro">
                    <tr>
                        <td>${cadastro.nome}</td>

                        <td class="col-xs-1">
                            <a href="atualizar/${parte.id}" class="fa fa-2x fa-edit"></a>

                        </td>
                        <td class="col-xs-1">
                            <a href="deletar/${parte.id}" onclick="return confirm('Deseja excluir o registro?')"class="fa fa-2x fa-trash"></a>
